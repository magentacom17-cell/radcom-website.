...
export const clientPartnersList: ClientPartner[] = [
  ...
  { name: 'Direktorat Tipidkor Bareskrim Polri', category: 'government', highlight: 'Penyediaan sistem IT & ruang koordinasi penegakan hukum' },
  { name: 'PT. Integrasi Jaringan Ekosistem (KAI)', category: 'enterprise', highlight: 'CCTV & Access Door 8 titik Shelter KAI' },
  { name: 'Royal Embassy of Saudi Arabia — Military Attaché', category: 'international', highlight: 'Instalasi 30 CCTV NVR & High-Security System' },

  // Organisasi Internasional & NGO Konservasi
  { name: 'WWF (World Wide Fund for Nature)', category: 'international', highlight: 'Konservasi & Perlindungan Lingkungan' },
  { name: 'CARE International', category: 'international', highlight: 'Organisasi Kemanusiaan Global' },
  { name: 'International SOS', category: 'international', highlight: 'Layanan Medis & Keselamatan Global' },
  { name: 'ChildFund International', category: 'international', highlight: 'Advokasi Anak & Perlindungan Sosial' },
  { name: 'ICRC (International Committee of the Red Cross)', category: 'international', highlight: 'Palang Merah Internasional' },
  { name: 'Yayasan Konservasi Alam Nusantara', category: 'international', highlight: 'Pelestarian Alam & Hutan' },
  { name: 'Yayasan Rumah Energi', category: 'international', highlight: 'Inovasi Energi Terbarukan & Biogas' },

  // Korporasi Multinasional, Industri & Manufaktur
  { name: 'Atlas Copco Indonesia', category: 'enterprise', highlight: 'Teknologi Kompresor & Industri Swedia' },
  { name: 'Oiltanking', category: 'enterprise', highlight: 'Terminal Tangki Minyak & Bahan Kimia' },
  { name: 'Control Union', category: 'enterprise', highlight: 'Inspeksi & Sertifikasi Komoditas Global' },
  { name: 'Peterson Supply Chain', category: 'enterprise', highlight: 'Logistik Terintegrasi Energi & Migas' },
  { name: 'Koltiva', category: 'enterprise', highlight: 'Agritech & Rantai Pasok Berkelanjutan' },
  { name: 'PT. International Chemical Industry (Baterai ABC)', category: 'enterprise', highlight: 'Industri Baterai Terkemuka Nasional' },
  { name: 'Chakra Jawara (TMT Group)', category: 'enterprise', highlight: 'Distributor Truk Heavy-Duty Iveco' },
  { name: 'Parker Engineering', category: 'enterprise', highlight: 'Rekayasa Perpipaan & Industrial HVAC' },
  { name: 'ANJ (Austindo Nusantara Jaya)', category: 'enterprise', highlight: 'Agribisnis Pangan & Energi Berkelanjutan' },
  { name: 'Hilti Indonesia', category: 'enterprise', highlight: 'Perangkat Konstruksi & Alat Berat Presisi' },
  { name: 'CNPC BGP Indonesia', category: 'enterprise', highlight: 'Eksplorasi Seismik Geofisika Migas' },
  { name: 'Heidelberg Indonesia', category: 'enterprise', highlight: 'Solusi Mesin Cetak Presisi Jerman' },
  { name: 'TÜV Rheinland Indonesia', category: 'enterprise', highlight: 'Lembaga Audit & Sertifikasi Teknis Global' },
  { name: 'Seascape Surveys Indonesia', category: 'enterprise', highlight: 'Survei Kelautan & Pekerjaan Bawah Air' },
  { name: 'PT. Interprima Indocom', category: 'enterprise', highlight: 'Manufaktur & Distribusi Kertas' },
  { name: 'PT. Danatel Pratama', category: 'enterprise', highlight: 'Infrastruktur Telekomunikasi Nasional' },
  { name: 'Berkat Jaya Beton', category: 'enterprise', highlight: 'Industri Beton Pracetak & Readymix' },
  { name: 'Agromedia Group', category: 'enterprise', highlight: 'Grup Penerbitan & Percetakan Terbesar' },
  { name: 'Penerbit Erlangga', category: 'enterprise', highlight: 'Penerbitan Buku Pendidikan Nasional' },
  { name: 'GF Culinary Group', category: 'enterprise', highlight: 'Jaringan Restoran & Kuliner Premium' },
  { name: 'Boncafé Indonesia', category: 'enterprise', highlight: 'Peralatan & Kopi Standar Internasional' },
  { name: 'Shipper Indonesia', category: 'enterprise', highlight: 'Agregator Logistik & Gudang Digital' },
  { name: 'Intracawind / Intracavision', category: 'enterprise', highlight: 'Manufaktur & Sarana Perkantoran' },

  // Perbankan & Finansial
  { name: 'Sinar Mas Group', category: 'banking', highlight: 'Konglomerasi Finansial & Industri' },
  { name: 'China Construction Bank (CCB) Indonesia', category: 'banking', highlight: 'Perbankan Multinasional' },
  { name: 'Mega Finance', category: 'banking', highlight: 'Lembaga Keuangan Konsumer CT Corp' },
  { name: 'Collega Inti Pratama', category: 'banking', highlight: 'Sistem Core Banking BPD Seluruh Indonesia' },
  { name: 'Silverlake Mobility Ecosystem', category: 'banking', highlight: 'Teknologi Finansial & Perbankan' },
  { name: 'Asuransi Rama Satria Wibawa', category: 'banking', highlight: 'Asuransi Kerugian & Perlindungan Umum' },
  { name: 'Moores Rowland Indonesia', category: 'banking', highlight: 'Kantor Akuntan Publik & Konsultan Pajak' },
  { name: 'Sintesa Group', category: 'banking', highlight: 'Holding Investasi Strategis Nasional' },

  // Kesehatan & Perhotelan
  { name: 'RS Tria Dipa Jakarta', category: 'hospitality', highlight: 'Fasilitas Layanan Kesehatan & Rawat Inap' },
  { name: 'idsMED Indonesia', category: 'hospitality', highlight: 'Distributor Alat Kesehatan & Medis' },
  { name: 'Alila Hotels & Resorts', category: 'hospitality', highlight: 'Resor Mewah Bertaraf Internasional' },
  { name: 'Harris Hotels', category: 'hospitality', highlight: 'Jaringan Hotel Bisnis Modern' },
  { name: 'The Hermitage Jakarta', category: 'hospitality', highlight: 'Tribute Portfolio Hotel Bintang Lima' },

  // Properti & Arsitektur
  { name: 'Indonesian Paradise Property', category: 'property', highlight: 'Pengembang Properti Komersial & Mall' },
  { name: 'Hadiprana Design', category: 'property', highlight: 'Konsultan Desain Arsitektur & Interior Legendaris' },
  { name: 'Bhumyamca Sekawan', category: 'property', highlight: 'Pengelola Kawasan Gedung Perkantoran' },
  { name: 'FABS Indonesia', category: 'property', highlight: 'Manajemen Konstruksi & Fasilitas Gedung' },
  { name: 'Graha Niaga Tata Utama', category: 'property', highlight: 'Manajemen Pengelolaan Properti Menara Niaga' },
  { name: 'The Summit Kelapa Gading', category: 'property', highlight: 'Hunian Vertikal Apartemen Mewah' },
];
